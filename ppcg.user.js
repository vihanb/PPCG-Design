...
if(/^https?:\/\/(?:meta.)?codegolf.stackexchange.com/.test(window.location)) {
  ...
  document.head.innerHTML += ("<style>@import url("+FONT_URL+");"+
    ...
    +"input[type=submit], input[type=button], button, .button, a.button, a.button:visited, .btn{"+(site=="meta"?"background-color:#303030 !important":"border:1px solid #6DAB71 !important;background-color:#6DAB71 !important")+";box-shadow:none}"+
    +(site=="main"?"input[type=submit]:hover, input[type=button]:hover, button:hover, .button:hover, a.button:hover, a.button:visited:hover, .btn:hover{border:1px solid #5DA261 !important;background-color:#5DA261 !important}":"")+
