...
if (/^https?:\/\/(?:meta.)?codegolf.stackexchange.com/.test(window.location)) {
  ...
  document.head.innerHTML += ("<style>@import url(" + FONT_URL + ");" +
    ...
    "a.post-tag{height: 13px;line-height: 13px;border-radius: 0;font-family:"+MONOSPACE_FONT+";font-size:12px;white-space: nowrap;background-color:$$TAG_COLOR;border-color:$$TAG_BORDER_COLOR; -webkit-transition: color 0.08s ease, background 0.08s ease, border-color 0.08s ease; -moz-transition: color 0.08s ease, background 0.08s ease, border-color 0.08s ease; -ms-transition: color 0.08s ease, background 0.08s ease, border-color 0.08s ease; -o-transition: color 0.08s ease, background 0.08s ease, border-color 0.08s ease}" +
